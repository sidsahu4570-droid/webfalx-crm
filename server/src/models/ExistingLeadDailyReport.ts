...
export interface IExistingLeadDailyReport extends Document {
...
const ExistingLeadDailyReportSchema: Schema = new Schema(
  {
...
ExistingLeadDailyReportSchema.index({ userId: 1, dateString: 1 }, { unique: true });

export const ExistingLeadDailyReport = mongoose.model<IExistingLeadDailyReport>(
  'ExistingLeadDailyReport',
  ExistingLeadDailyReportSchema,
  'existingleaddailyreports'
);
